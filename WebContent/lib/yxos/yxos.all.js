...
+ function($, win){
	...
	win.YXOs = {
		...
		addEvent: function(key, callback){
			eventStore[key] = callback;
		},
		
		callEvent: function(key, param){
			if(eventStore[key] && Object.prototype.toString.call(eventStore[key]) === '[object Function]'){
				eventStore[key].call(this, param);
			}
		},
...
+ function($, win, os){
	...
	os.YXWindow.prototype = {
		...
		init: function(ops){
			...
			html += '	 </div>';
			html += '</div>';
			if(!os.globalConfig.disabledWindowResize){
		...
		bindEvent: function(){
			...
			self.moveCover.on('mouseup', function(e){
				self.focus();
				self.moveEnd();
				clicked = "Nope.";
				if(timeoutHandle != -1){
			...
			$("html").mousemove(function (event) {        	
	            ...
	            if (clicked == "Yeah.") {
	                if(way === "bottom-right"){ // 右下角
	                	difw = mausx - self.left + dpx;
	                	difh = mausy - self.top + dpx;
		            	self.body.css({ width: difw, height: difh });
		            	self.width = difw;
		            	self.height = difh;
		            } else if(way === "bottom-left"){ // 左下角
		            	difw = self.left - mausx + self.width + dpx;
	                	difh = mausy - self.top + dpx;
		            	self.body.css({left: mausx - dpx, width: difw, height: difh });
		            	self.left = mausx - dpx;
		            	self.width = difw;
		            	self.height = difh;
		            } else if(way === "top-left"){ // 左上角
		            	difw = self.left - mausx + self.width + dpx;
	                	difh = self.top - mausy + self.height + dpx;
		            	self.body.css({left: mausx - dpx, top: mausy - dpx, width: difw, height: difh });
		            	self.left = mausx - dpx;
		            	self.top = mausy - dpx;
		            	self.width = difw;
		            	self.height = difh;
		            	...
		            	difw = mausx - self.left + dpx;
	                	difh = self.top - mausy + self.height + dpx;
		            	self.body.css({top: mausy - dpx, width: difw, height: difh });
		            	self.top = mausy - dpx;
		            	self.width = difw;
		            	self.height = difh;
		            } else if(way === "top"){ // 上
	                	difh = self.top - mausy + self.height + dpx;
		            	self.body.css({top: mausy - dpx, height: difh });
		            	self.top = mausy - dpx;
		            	self.height = difh;
	                	...
	                	difw = self.left - mausx + self.width + dpx;
		            	self.body.css({left: mausx - dpx, width: difw });
		            	self.left = mausx - dpx;
		            	self.width = difw;
		            } else if(way === "right"){ // 右
	                	difw = mausx - self.left + dpx;
...
+ function($, win, os){
	...
	os.YXTaskBar = function(){
		this.body = $('<div id="yxos-taskbar" class="yxos-taskbar"><div class="taskbar-start"><div class="window-start-menu"><i class="icon icon-windows"></i></div></div><div class="taskbar-tab"></div><div class="taskbar-func"></div></div>');
	...
	os.YXTaskBar.prototype = {
		...
		bindEvent: function(){
			...
			self.start_menu.on('click', function(){
				if(self.start_menu.hasClass('active')){
					self.start_menu.removeClass('active');
				} else {
					self.start_menu.addClass('active');
				}
				os.callEvent('WindowStartMenuClick', os.desktop.startMenu);
			});
		},
...
+ function($, w, os){
	...
	var YXDesktop = function(){
		...
		this.wallpaperStore = [
			"lib/yxos/skin/wallpaper/w001.jpg",
			"lib/yxos/skin/wallpaper/w002.jpg",
			"lib/yxos/skin/wallpaper/w003.jpg",
			"lib/yxos/skin/wallpaper/w004.jpg",
			"lib/yxos/skin/wallpaper/w005.jpg",
			"lib/yxos/skin/wallpaper/w006.jpg",
			"lib/yxos/skin/wallpaper/w007.jpg",
			"lib/yxos/skin/wallpaper/w008.jpg",
			"lib/yxos/skin/wallpaper/w009.jpg",
